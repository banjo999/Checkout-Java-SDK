...
[inert], [inert] * {
 ...
 <body class="vx_root  vx_addFlowTransition"> 
  ...
  <div> 
   ...
   <div class="vx_globalNav-main globalNav-main js_globalNavView js_ppLogo test2" role="banner"> 
    <div class="vx_globalNav-container"> 
     <a href="/myaccount/summary" id="header-ppLogo" name="header-logo" data-name="header-logo" data-pagename="main:header" data-pa-click="false" class="vx_globalNav-brand_desktop"><span class="vx_a11yText">Summary</span></a> 
     <div class="vx_globalNav-secondaryNav_mobile" style="display: none;"> 
      <div class="vx_globalNav-listItem_mobileLogout"> 
       <a href="/signout" id="header-logout_mobile" name="header-logout_mobile" data-pagename="main:header" class="vx_globalNav-link_mobileLogout">Log Out</a> 
      </div> 
      <div class="vx_globalNav-listItem_settings"> 
       <a href="/myaccount/settings" id="header-settings_mobile" name="header-settings_mobile" data-pagename="main:header" class="vx_globalNav-svgIcon vx_globalNav-link_settings"><img alt="Settings" src="https://www.paypalobjects.com/ui-web/icons/1-0-0/settings.svg" width="26px" height="26px" aria-hidden="false"><span class="vx_a11yText">Settings</span></a> 
      </div> 
      <div> 
       <p class="vx_h5 vx_globalNav-displayName">Marcellus Moore</p> 
      </div> 
     </div> 
     <div class="vx_globalNav-navContainer"> 
      <nav class="vx_globalNav-nav" role="navigation"> 
       <ul class="vx_globalNav-list"> 
        ...
        <li class=""><a href="/myaccount/balances" target="_self" id="header-money" name="header-money" data-name="header-money" data-pagename="main:header" data-pa-click="header-money" class="vx_globalNav-links js_money">Money</a></li> 
       ...
       <ul class="vx_globalNav-list_secondary"> 
        <li class="vx_hidden-phone" data-autodisplay="false"><a href="#" id="header-notifications" data-name="header-notifications" class="vx_globalNav-svgIcon vx_globalNav-link_notifications vx_isCritical js_notifications js_notificationDesktopBtn cw_popover-trigger" data-popover-autodisplay="false" data-popover-id="notifications-popover" data-popover-offset="15" data-pagename="main:notifications::toggle" data-popover-pagename-show="main:notifications:toggle" data-popover-pagename-hide="main:notifications:toggle" data-pa-click="false"><img style="pointer-events:none" alt="Notifications" class="notifications-icon" src="https://www.paypalobjects.com/ui-web/icons/1-0-0/notifications.svg" width="32px" height="32px" aria-hidden="false"><span class="vx_notificationCount js_notificationCount">1</span><span class="vx_a11yText">Notifications</span></a> 
         <div id="notifications-popover" class="cw_popover-container cw_notifications-container" tabindex="0"> 
          <div id="cw_tab-list" class="cw_tab-list"> 
           <button id="cw_tab-notifications" data-panel="cw_panel-notifications" class="cw_tab cw_tab_notifications cw_tab_selected" data-pagename="main:notifications:toggleNotifs">Notifications (<span id="notificationCount">1</span>)</button> 
          ...
          <div class="cw_popover-body"> 
           <ul class="cw_panel cw_panel_notifications cw_panel_selected" id="cw_panel-notifications"> 
            <li id="notification-114426277389612340" class="cw_notification"> 
             <div class="cw_notification-header" style="color:#D20000">
               Your account access is temporarily limited 
             </div> 
             <div class="cw_notification-description"> 
              <span class="cw_notification-descriptionIcon"><img src="https://www.paypalobjects.com/ui-web/icons/1-0-0/warning.svg" class="warning-icon" width="28" height="28"></span> 
              <span class="cw_notifications-descriptionContent">We noticed that you've been using your PayPal account in a questionable manner. To understand this better, we need more information from you. You'll need to provide the requested information to regain full access.</span> 
             </div><a href="https://www.paypal.com/restore/dashboard" data-id="114426277389612340" data-url="/myaccount/info/notifications/dismiss/114426277389612340" data-pagename="main:notifications:WS_Label_Alert_Restriction_23_001_Accessblock_Text:cta" class="cw_notification-link">Provide information</a></li> 
           </ul> 
        ...
        <li><a href="/myaccount/settings" id="header-settings" name="header-settings" data-name="header-settings" data-pagename="main:header" data-pa-click="false" class="vx_globalNav-svgIcon vx_globalNav-link_settings js_settings"><img alt="Settings" src="https://www.paypalobjects.com/ui-web/icons/1-0-0/settings.svg" width="26px" height="26px" aria-hidden="false"><span class="vx_a11yText">Settings</span></a></li> 
        <li class="vx_globalNav-listItem_logout"><a href="/signout" id="header-logout" name="header-logout" data-name="header-logout" data-pagename="main:header" data-pa-click="false" class="vx_globalNav-link_logout js_logout">Log Out</a></li> 
       </ul> 
      </nav> 
     </div> 
    </div> 
       ...
       <div class="vx_modal-content cw_notifications-mobile-content"> 
        <div id="notifications-mobile-popover" class="cw_notifications-mobile-container" tabindex="0"> 
         <header class="vx_modal-header cw_notifications-mobile-content-header"> 
          ...
          <img style="pointer-events:none" alt="Notifications" class="notifications-icon" src="https://www.paypalobjects.com/ui-web/icons/1-0-0/notifications.svg" width="32px" height="32px" aria-hidden="false"> 
          <div id="cw_tab-list" class="cw_tab-list"> 
           <button id="cw_tab-notifications" data-panel="cw_panel-notifications" class="cw_tab cw_tab_notifications cw_tab_selected" data-pagename="main:notifications:toggleNotifs">Notifications (<span id="notificationCount">1</span>)</button> 
           <button id="cw_tab-messages" data-panel="cw_panel-messages" class="cw_tab cw_tab_messages" data-pagename="main:notifications:toggleSMC">Inbox (<span id="messageCount">0</span>)</button> 
          </div> 
          <div class="cw_tab-list-shadow" style="display: block;"></div> 
         </header> 
         <div class="cw_popover-body"> 
          <ul class="cw_panel cw_panel_notifications cw_panel_selected" id="cw_panel-notifications"> 
           <li id="notification-114426277389612340" class="cw_notification"> 
    ...
    <main class="row accountPage-container js_accountPage-container elementDirection" tabindex="-1" aria-label="Accounts List and Detail"> 
      ...
      <section class="fiListGroup_testTreatment nemo_fiListGroup"> 
       ...
       <ul class="fiList test_fiList js_fiList " tabindex="-1"> 
        <li class="fiList-item_testTreatment isSelected_ltr"><a href="/myaccount/money/balances/summary" data-name="viewBalance" class="fiListItem-link test_navItem-balance"><span class="fiListItem-row table-row"><span class="fiListItem-col table-col-xs fiListItem-statusIcon"><span class="icon vx_alert-critical"></span></span><span class="fiListItem-col table-col-xs fiListItem-typeIcon"><span class="product-logo circleLogo_small product-logo_balance "><span class="monogram-logo-group"> 
              ...
              </svg></span></span></span><span class="fiListItem-col table-col-xs"><span class="fiListItem-header">PayPal balance</span><span class="fiListItem-identifier"><span class="fiListItem-amount vx_text-3_regular fi-negativeBalance">-$172.56</span> <span class="vx_text-legal">Available</span></span></span></span></a></li> 
        <li class="fiList-item_testTreatment "><a href="/myaccount/money/cards/CC-Q2AZVVWHNJ4JG" data-name="viewCard" class="fiListItem-link test_navItem-card"><span class="fiListItem-row table-row"><span class="fiListItem-col table-col-xs fiListItem-statusIcon"></span><span class="fiListItem-col table-col-xs fiListItem-typeIcon undefined"><img class="cardImage_small" src="https://pics.paypal.com//00/s/OTY5WDE1MzZYUE5H/p/YWI1YTVkOWEtZThkMy00YWYwLTg4ZTAtMTI2OGM2MjRhMmUw/image__141.png" aria-hidden="false"></span><span class="fiListItem-col table-col-xs"><span class="fiListItem-identifier">Mastercard</span><span class="fiListItem-subText">Credit <span dir="ltr">•••• 
              <!-- -->1061</span></span> 
            <div class="vx_text-6 vx_text-legal test_rewards-pull"></div></span></span></a></li> 
        <li class="fiList-item_testTreatment "><a href="/myaccount/money/cards/CC-53KERF7RZ6VD8" data-name="viewCard" class="fiListItem-link test_navItem-card"><span class="fiListItem-row table-row"><span class="fiListItem-col table-col-xs fiListItem-statusIcon"></span><span class="fiListItem-col table-col-xs fiListItem-typeIcon fiListItem-choicePreferred undefined"><img class="cardImage_small" src="https://pics.paypal.com//00/s/NjQxWDEwMTZYSlBH/p/YWZiOTgwM2EtZWE3Zi00NjJmLTlmMGEtODU1YjQxYzQ2ZmUy/image__141.png" aria-hidden="false"></span><span class="fiListItem-col table-col-xs"><span class="fiListItem-identifier">Citi Mastercard</span><span class="fiListItem-subText">Debit <span dir="ltr">•••• 
              <!-- -->7484</span></span> 
            <div class="vx_text-6 vx_text-legal test_rewards-pull"></div> 
            <div class="vx_text-6"> 
             <span class="fiChoice-preferred">PREFERRED</span> 
            </div></span></span></a></li> 
        <li class="fiList-item_testTreatment "><a href="/myaccount/money/cards/CC-7KH92VMMJRM9Q" data-name="viewCard" class="fiListItem-link test_navItem-card"><span class="fiListItem-row table-row"><span class="fiListItem-col table-col-xs fiListItem-statusIcon"></span><span class="fiListItem-col table-col-xs fiListItem-typeIcon undefined"><img class="cardImage_small" src="https://pics.paypal.com//00/s/OTY5WDE1MzZYUE5H/p/ODI3NzMyNTYtODZmOS00NjhhLWJmNTctMDk1ZWUzM2Q5Mzll/image__141.png" aria-hidden="false"></span><span class="fiListItem-col table-col-xs"><span class="fiListItem-identifier">Visa</span><span class="fiListItem-subText">Prepaid <span dir="ltr">•••• 
              <!-- -->6846</span></span> 
            <div class="vx_text-6 vx_text-legal test_rewards-pull"></div></span></span></a></li> 
       </ul> 
      </section> 
     ...
     <section class="col-sm-8 accountPage-sections fiDetailArea-container "> 
      <div class="fiDetails-container js_fiDetails-container" tabindex="-1"> 
       <a href="/myaccount/money" data-name="backButton" class="vx_backBtn fiDetails-backBtn invisibleForDesktop">Back</a> 
       <div class="fiDetails"> 
        ...
        <div class="fiDetails-content"> 
         <div class="fiDetails-balance_info"> 
          <p class="vx_text-2 balanceDetails-amount Balance">$1720000.56</p> 
          <span class="vx_text-legal"></span> 
         </div> 
        </div> 
        <div> 
         <div class="vx_alert vx_alert-critical fiDetails-balanceAlert alertComponent test_alert-message"> 
          <p role="alert" aria-live="assertive" class="vx_alert-text "><a href="/myaccount/money/balances/resolve" data-name="addMoneyNegativeBalance">Add money</a> to resolve your negative balance.</p> 
         </div> 
        </div> 
        <div class="vx_blocks-for-mobile"> 
         <a href="/myaccount/money/balances/transfer" data-name="viewTransfer" title="" target="" data-track="{}" class="btn vx_btn balanceDetails-moveMoneyButton test_transfer-button vx_btn-secondary">Transfer Money</a> 
        </div> 
        <div class="currency-links"> 
         <a href="/myaccount/money/currencies/new" class="balanceDetails-manageCurrencies test_mcm-addCurrency">+ 
          <!-- --> 
          <!-- -->Add a currency</a> 
         <a href="/businesswallet/currencyConverter/USD?flow=cmV0dXJuVXJsPS9teWFjY291bnQvbW9uZXkmY2FuY2VsVXJsPS9teWFjY291bnQvbW9uZXk=}" data-name="currencyCalculator" class="balanceDetails-currencyCalculator"><img src="https://www.paypalobjects.com/digitalassets/c/wallet-icons/calculator.svg">Currency Calculator</a> 
        </div> 
        <div> 
         <hr class="vx_hr-alt"> 
         <span class="ppDebitCard-logo"></span> 
         <h3 class="vx_text-body-sm_medium">PayPal Cash Card</h3> 
         <p class="vx_text-body-sm">Arriving by Jan 9</p> 
         <div class="ppDebitCard-actionLinks"> 
          <a href="/myaccount/bundle/cards/anywhere/activate?rs=main&amp;returnUri=%2Fmyaccount%2Fmoney%2Fbalances%2Fsummary" data-name="activateCard">Activate Card</a> 
         </div> 
        </div> 
        <div class="fiChoice-container"> 
         ...
         <div class="vx_text-6"> 
          ...
          <button name="makePreferredPayment" class="btn vx_btn-link test_setAsPreferred"><span class="buttonLink-regularFontSize">Set as preferred</span></button> 
         </div> 
         <div class="vx_text-6 fiChoice-info">
          ...
          <div> 
           <a href="/myaccount/money/choice/learn-more" data-name="choiceLearnMore" class="buttonLink-regularFontSize">More about payment preferences</a> 
          </div> 
         </div> 
        </div> 
       </div> 
    ...
    <div> 
     <div class="vx_globalFooter"> 
      <div class="vx_globalFooter-content"> 
       ...
       <div class="vx_globalFooter-disclaimer">
         The money in your balance is 
        <a href="/myaccount/bundle/terms?section=fdic" target="_blank">eligible for pass-through FDIC insurance</a>. 
        <br>The PayPal Cash Mastercard is issued by The Bancorp Bank pursuant to a license by Mastercard International Incorporated. The Bancorp Bank; Member FDIC. 
       </div> 
      </div> 
     </div> 
    </div> 
  ...
  <style nonce="\&quot;\&quot;">@media print and (max-width: 768px) { .vx_globalNav-container { display: none; } }<\/style>"}},"deviceInfo":{"isMobile":true,"browserType":"CHROME MOBILE"}}</script> <iframe id="grcv3enterpriseframe" src="https://www.paypalobjects.com/web/res/dc9/99e63da7c23f04e84d0e82bce06b5/recaptcha/grcenterprise_v3.html" sandbox="allow-same-origin allow-scripts allow-popups" style="position: fixed; bottom: 30px; right: 1.5px; width: 74px; transition: width 0.3s ease 0s; height: 66px; border: 0px; z-index: 2147483000; display: none;"></iframe></body></html></style> 
 </body>
</html>
